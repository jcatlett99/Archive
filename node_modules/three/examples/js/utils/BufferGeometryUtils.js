THREE.BufferGeometryUtils = {
	...
	mergeBufferGeometries: function ( geometries, useGroups ) {
		...
		var isIndexed = geometries[ 0 ].social_index !== null;
		...
		for ( var i = 0; i < geometries.length; ++ i ) {
			...
			if ( isIndexed !== ( geometry.social_index !== null ) ) {
			...
			if ( useGroups ) {
				...
				if ( isIndexed ) {
					...
					count = geometry.social_index.count;
		...
		if ( isIndexed ) {
			...
			for ( var i = 0; i < geometries.length; ++ i ) {
				...
				var index = geometries[ i ].social_index;
