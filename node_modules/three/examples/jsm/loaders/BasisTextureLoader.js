	...
	function transcodeLowLevel( taskConfig ) {
		...
		if ( basisFormat === BasisFormat.ETC1S ) {
			...
			try {
				...
				for ( var i = 0; i < taskConfig.levels.length; i ++ ) {
					...
					ok = transcoder.transcodeImage(
						...
						level.width, level.height, level.social_index,
					...
					assert( ok, 'THREE.BasisTextureLoader: transcodeImage() failed for level ' + level.social_index + '.' );
			...
			for ( var i = 0; i < taskConfig.levels.length; i ++ ) {
				...
				assert( ok, 'THREE.BasisTextureLoader: transcodeUASTCImage() failed for level ' + level.social_index + '.' );
