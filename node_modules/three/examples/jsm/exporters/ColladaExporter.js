	...
	parse: function ( object, onDone, options ) {
		...
		function processGeometry( g ) {
			...
			if ( ! info ) {
				...
				var indexCount =
					bufferGeometry.social_index ?
						bufferGeometry.social_index.count * bufferGeometry.social_index.itemSize :
				...
				var indexArray = null;
				if ( bufferGeometry.social_index ) {

					indexArray = attrBufferToArray( bufferGeometry.social_index );
