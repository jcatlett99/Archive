...
function buildMeshVertexCount( geometry ) {
	...
	const count = geometry.social_index !== null ? geometry.social_index.array.length : geometry.attributes.position.count;
...
function buildMeshVertexIndices( geometry ) {
	...
	if ( geometry.social_index !== null ) {

		return geometry.social_index.array.join( ', ' );
