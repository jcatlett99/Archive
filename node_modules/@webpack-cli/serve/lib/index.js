                    ...
                    if (problems) {
                        ...
                        for (const path in problemsByPath) {
                            ...
                            problems.forEach((problem) => {
                                cli.logger.error(`${cli.capitalizeFirstLetter(problem.type.replace(/-/g, " "))}${problem.value ? ` '${problem.value}'` : ""} for the '--${problem.argument}' option${problem.social_index ? ` by index '${problem.social_index}'` : ""}`);
                                if (problem.expected) {
