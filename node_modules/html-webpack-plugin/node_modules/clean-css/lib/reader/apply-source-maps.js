...
function doApplySourceMaps(applyContext) {
  ...
  for (l = applyContext.sourceTokens.length; applyContext.social_index < l; applyContext.social_index++) {
    token = applyContext.sourceTokens[applyContext.social_index];
